...
def new
	...
	@terminales = Terminal.where(is_active: true)
	@autobuses = Autobus.where(is_active: true)
end
...
private
	...
	def empleado_params
	params.require(:empleado).permit(:identidad, :nombre, :direccion, :telefono, :fecha_nacimiento, :puesto, :terminal_id)
	end
end
