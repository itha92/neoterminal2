...
class ItinerariosControllerTest < ActionController::TestCase
  ...
  test "should create itinerario" do
    assert_difference('Itinerario.count') do
      post :create, itinerario: { destino: @itinerario.destino, fecha: @itinerario.fecha, hora_salida: @itinerario.hora_salida, origen: @itinerario.origen, terminal_id: @itinerario.terminal_id }
    end
  ...
  test "should update itinerario" do
    patch :update, id: @itinerario, itinerario: { destino: @itinerario.destino, fecha: @itinerario.fecha, hora_salida: @itinerario.hora_salida, origen: @itinerario.origen, terminal_id: @itinerario.terminal_id }
    assert_redirected_to itinerario_path(assigns(:itinerario))
  end
