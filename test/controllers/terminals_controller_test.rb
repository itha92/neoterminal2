...
class TerminalsControllerTest < ActionController::TestCase
  ...
  test "should create terminal" do
    assert_difference('Terminal.count') do
      post :create, terminal: { codigo: @terminal.codigo, direccion: @terminal.direccion, is_active: @terminal.is_active, telefono: @terminal.telefono }
    end
  ...
  test "should update terminal" do
    patch :update, id: @terminal, terminal: { codigo: @terminal.codigo, direccion: @terminal.direccion, is_active: @terminal.is_active, telefono: @terminal.telefono }
    assert_redirected_to terminal_path(assigns(:terminal))
  end
